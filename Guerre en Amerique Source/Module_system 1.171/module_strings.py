...
#npc22 = isosangemat
  ...
  ("npc1_payment", "Hey thank you captain. But before joining up with you, I would ask for a payment of {reg3} Spanish Dollars. I know that in war parties soldiers can go on for weeks without seeing any wages. I am wise enough not to sign anywhere without having myself covered."),
  ("npc2_payment", "{!}."),
  ("npc3_payment", "{!}."),
  ("npc4_payment", "Excellent. Before we depart, would you be so kind to lend me {reg3} Spanish Dollars? I had to pawn a family heirloom at a pawnbroker here in {s20}, and I would like to retrieve it before we leave."),
  ("npc5_payment", "Thank you. Now, to seal off our agreement, I ask for {reg3} Spanish Dollars from you. It's an advice my father gave me. He told me 'Meiling, never fight for a barbarian before {he/she} pays you your worth of gold first'."),
  ("npc6_payment", "{!}."),
  ("npc7_payment", "All right then. I will come with you. But I want a payment of {reg3} Spanish Dollars first. You aren't expecting me to work for free, do you?"),
  ("npc8_payment", "I have to warn you, I have to live off a stipend. My mission ran out of money decades ago, and we've been operating from donations ever since. A {reg3} Spanish Dollars endowment from you would let me last almost indefinitely."),
  ("npc9_payment", "That's very good of you. And before I join, can you lend me {reg3} Spanish Dollars, so that I can buy some proper clothing that befits a woman of noble birth such as myself. My kimono has been worn down badly due to my recent bad fortune, and I cannot let common soldiers mistake me as one of their own."),
  ("npc10_payment", "That's good news. But I'll ask for one last thing, captain. I have a woman here in {s20}, and she says she has my child in her belly. I want to give her some money before I leave... for the child, you know. Do you think you can spare {reg3} Spanish Dollars?"),
  ("npc11_payment", "I will be very useful to you, {sir/madam}, you can bet on that. Just one more thing before we leave, would you mind lending me {reg3} Spanish Dollars? I am ashamed to say it, but I have made myself a bit of debt here, staying in this tavern over the last few weeks and the tavern owners no longer believe that I am loaded with gold as I used to tell them. You know, things could get ugly here if they see me leaving with you before paying them."),
  ("npc12_payment", "{!}."),
  ("npc13_payment", "Before I sign up, there is the small matter of some expenses I have incurred while staying here -- {reg3} Spanish Dollars. Do you think that you could cover those for me, as a gesture of friendship?"),
  ("npc14_payment", "Ah, one last thing. I would ask for an initial bounty of {reg3} Spanish Dollars before I join your command. It's my principle never to enter someone's service without receiving the payment I deserve."),
  ("npc15_payment", "Good. By the way, as a skilled archer I would expect a payment for my services. A signing bonus of {reg3} Spanish Dollars would be fair, I think."),
  ...
  ("npc17_payment", "Likewise. Before we go, I require {reg3} Spanish Dollars to provision myself for campaigning."),
  ("npc18_payment", "{!}."),
  ("npc19_payment", "{!}."),
  ("npc20_payment", "Great, great. I need {reg3} Spanish Dollars first though, as a kind of insurance in case we don't get any pillaging done anytime soon."),
  ("npc21_payment", "Before we go, I need {reg3} Spanish Dollars to equip myself and such."),
  ("npc22_payment", "{!}."),

  ("npc1_payment_response", "Very well, here's {reg3} Spanish Dollars. Make yourself ready. We leave soon."),
  ("npc2_payment_response", "{!}."),
  ("npc3_payment_response", "{!}."),
  ("npc4_payment_response", "Certainly. Here's {reg3} Spanish Dollars."),
  ("npc5_payment_response", "Well... here's {reg3} Spanish Dollars, then. Your first payment."),
  ("npc6_payment_response", "{!}."),
  ("npc7_payment_response", "No, of course not. Here's {reg3} Spanish Dollars."),
  ("npc8_payment_response", "Very well, here's {reg3} Spanish Dollars for your mission."),
  ("npc9_payment_response", "Very well, here's {reg3} Spanish Dollars."),
  ("npc10_payment_response", "Of course. Here, {reg3} Spanish Dollars."),
  ("npc11_payment_response", "Very well, here's {reg3} Spanish Dollars. Now, fall in with the rest."),
  ("npc12_payment_response", "{!}."),
  ("npc13_payment_response", "Of course, here's {reg3} Spanish Dollars. Make ready to leave soon."),
  ("npc14_payment_response", "All right, here's {reg3} Spanish Dollars. You are most welcome in our company."),
  ("npc15_payment_response", "All right, here's {reg3} Spanish Dollars. Glad to have you with us."),
  ("npc16_payment_response", "All right, here's {reg3} Spanish Dollars for you. Make yourself ready."),
  ("npc17_payment_response", "Here's {reg3} Spanish Dollars. Get ready. We leave soon."),
  ("npc18_payment_response", "{!}."),
  ("npc19_payment_response", "{!}."),
  ("npc20_payment_response", "Very well, here's {reg3} Spanish Dollars. Make yourself ready. We leave soon."),
  ("npc21_payment_response", "Very well, here's {reg3} Spanish Dollars. Make yourself ready. We leave soon."),
...
("comment_intro_famous_liege", "Your prowess in battle and presence in social circles is well known! Perhaps it is time that you sought a commission as an officer."),
("comment_intro_famous_martial", "Aha the famous {playername}, I've heard of your skills on the battlefield!"),
...
#courtship
  ...
  ("kingdom_1_adjective",                     "British"),
  ("kingdom_2_adjective",                     "French"),
  ("kingdom_3_adjective",                     "Spanish"),
  ...
  ("kingdom_11_adjective",                     "Lenape"),
  ("kingdom_12_adjective",                     "Choctaw"),
  ("kingdom_13_adjective",                     "Unused"),
  ("kingdom_14_adjective",                     "Unused"),
  ("kingdom_15_adjective",                     "Unused"),
  ("kingdom_16_adjective",                     "Unused"),
  ("kingdom_17_adjective",                     "Unused"),
  ("kingdom_18_adjective",                     "Unused"),
  ("kingdom_19_adjective",                     "Unused"),
  ("kingdom_20_adjective",                     "Unused"),
...
#gekokujo 3.0 lords don't marry freelancer players! end
  ...
  ("outside_calradia", "outside North America."),
...
##diplomacy end+
  ...
  ("villagers_from_s1_stole_some_cattle_from_s2", "thiefs from {s1} ransacked the food stores of {s2}, straining relations between their respective nations"),
  ("villagers_from_s1_abducted_a_woman_from_a_prominent_family_in_s2_to_marry_one_of_their_boys", "a person from {s1} killed another person from {s2} in an unsanctioned duel and the dead man's friends and family want revenge"),
  ("villagers_from_s1_killed_some_farmers_from_s2_in_a_fight_over_the_diversion_of_a_stream", "persons from {s1} robbed some farmers from {s2} while they were taking their goods to market, compensation is demanded by the afflicted parties"),
...
##diplomacy end+
  ...
  ("wounded_by_bandit_at_alley_fight", "You keel over in agony. However, before you lose too much blood or consciousness, you hear shouts and a rush of footfalls... You awake to find yourself indoors, debilitated but still moving."),
  ...
  #GeA starting locations placeholder
  ("journey_to_louisbourg", "You have arrived in Louisbourg, the gateway to New France and the lucrative trades she promises."), #France town_9

  ("journey_to_new_york", "You have arrived at the bustling colony on Manhattan, New York."), #British town_4

  ("journey_to_waawiyaatanong", "After naviagating the many great lakes of this untapped continent you arrive at the artery of the fur trade, Fort Pontchartrain, known to the natives as Waawiyaatanong."), #Odawa town_29

  ("journey_to_sonnontio", "Your trek has led to the bastion of the Shawnee, and of Native settlement in the Ohio, Sonnontio."), #Shawnee town_28

  ("journey_to_havana", "You have come upon Havana, the jewel of the Spanish Main and the bastion of the Indies."), #Spanish town_16

  ("journey_to_onondaga", "You've arrived at the land of the Onondaga, heart of the Iroquois, and location of the central fire."), #Iroquois town_20
...
("as_you_no_longer_maintain_an_independent_kingdom_you_no_longer_maintain_a_court",  "As you are no longer sovereign, your titles and lands find themselves under more capable leadership."),

("rents_from_s0",  "Rents from {s0}:"),
("tariffs_from_s0",  "Tariffs from {s0}:"),
("general_quarrel",  " We've found ourselves on the opposite side of many arguments over the years, and our relationship is. . . strained."),
...
("the_coast", "the coast"),
  ...
  ("s12s15_declared_war_to_control_calradia", "{s12}{s15} may attack {s16} without pretext, as a bid to extend control over all of North America."),
...
###################################################################################
 ...
 #TODO: customize responses by relation and/or personality
  ...
  ("dplmc_fief_exchange_listen_player_approval", "This is somewhat unusual, but since you're sovereign there is no one to object.  Which fief of mine did you have in mind?"),
  ...
  ("dplmc_fief_exchange_refuse_town", "I don't want to exchange a town for a fort or village."),
  ("dplmc_fief_exchange_refuse_castle", "I don't want to exchange a fort for a mere village."),
  ...
  ("dplmc_fief_exchange_accept_reg3_denars", "That exchange is acceptable to me, if you are willing to provide {reg3} Spanish Dollars to cover my expenses from the relocation."),

  ("dplmc_fief_exchange_confirm","It is settled then."),
  ("dplmc_fief_exchange_confirm_reg3_denars","It is settled then.  Here are your {reg3} Spanish Dollars."),
  #Other dialog
  ...
  ("dplmc_comment_you_enfiefed_a_commoner_supportive",  "I understand that you have given {s51} to {s54}.  Others may find this controversial, but I believe that {s54} will be an able governor, and that {reg4?she:he} will not disappoint."),
  #forms of address
 ...
 ("gekokujo_fort_1_guard_talk", "Under you {sir/ma'am} we've flourished much more than before, thank you."),
 ("gekokujo_fort_2_guard_talk", "{Zijne Excellentie/Uwe Hoogheid}?"),
 ("gekokujo_fort_3_guard_talk", "What are you doing all the way out here mon Chef?"),
 ("gekokujo_fort_4_guard_talk", "Yes, fellow true-born {son/daughter} of liberty?"),
 ("gekokujo_fort_5_guard_talk", "{Fre/Seu} mi kyan elp you?"),
 ("gekokujo_fort_6_guard_talk", "Nitokimam {playername}!"),
 ("gekokujo_fort_7_guard_talk", "Mugwump {playername}!"),
 ("gekokujo_fort_8_guard_talk", "You grace us with your presence, Waijawahn!"),
 ("gekokujo_fort_9_guard_talk", "Eractasswa, today is a good day!"),
 ("gekokujo_fort_10_guard_talk", "Mentor, it is good to have you here!"),
 ("gekokujo_fort_11_guard_talk", "Mentor, we await your orders."),
 ("gekokujo_fort_12_guard_talk", "May the father of understanding guide us, {playername}."),
 
 ("gekokujo_fort_1_deputy_conquer", "No doubt you've come for our furs, well I'm certain the crown will be none to happy about this. . ."),
 ("gekokujo_fort_2_deputy_conquer", "These Caribbean posts always seem to bring despair to any soldier meant to protect them."),
 ("gekokujo_fort_3_deputy_conquer", "This far flung frontier post was never meant as more than an enterprise to control trade, it'd be no different if you controlled it."),
 ("gekokujo_fort_4_deputy_conquer", "We need strong leadership, please be so kind as to offer it to us!"),
 ("gekokujo_fort_5_deputy_conquer", "Wi dun lose dis battle yah, but me a beg yuh, tell me seh yuh come fi tek up wi fight fah freedom."),
 ("gekokujo_fort_6_deputy_conquer", "Kamwatan, you've come on this day and conquered our people, spare us and we will make you Okimam."),
 ("gekokujo_fort_7_deputy_conquer", "We have lived here for generations only to be beaten by you, please do not take us as slaves, let us remain on the land and we can work together."),
 ("gekokujo_fort_8_deputy_conquer", "Long have we suffered the Wopayuwin, have you come to set us free, or to use us further?"),
 ("gekokujo_fort_9_deputy_conquer", "King Hagler won't stand for this, you'll surely meet him on the battlefield."),
 ("gekokujo_fort_10_deputy_conquer", "Please meet with our leader, Mentor Adewale, to decide our fate."),
 ("gekokujo_fort_11_deputy_conquer", "My home is now yours, I came in the hopes of freeing this continent, yet I find myself beaten and with nothing to show for it."),
 ("gekokujo_fort_12_deputy_conquer", "Please meet with Grand Master Kenway, as to ascertain what will become of us."),
 
 ("gekokujo_fort_1_deputy_conquer_response", "The fur trade is mine, and this will be my base of operations on the Hudson Bay."),
 ("gekokujo_fort_2_deputy_conquer_response", "I will make my home here on Sint Maarten, and I will exact a tax as its new governor."),
 ("gekokujo_fort_3_deputy_conquer_response", "Away from prying eyes, and with a bountiful amount of opportunity, I like it."),
 ("gekokujo_fort_4_deputy_conquer_response", "You'll have my leadership, and together we'll free this continent from sovereigns a world away."),
 ("gekokujo_fort_5_deputy_conquer_response", "The plight and travesty of slavery ends here and now!"),
 ("gekokujo_fort_6_deputy_conquer_response", "I shall lead as your chieftain, together we will make a profit."),
 ("gekokujo_fort_7_deputy_conquer_response", "Along this river your people will continue to thrive, as long as they don't go against my wishes."),
 ("gekokujo_fort_8_deputy_conquer_response", "I will use you as I see fit, I am the one they call {playtername}."),
 ("gekokujo_fort_9_deputy_conquer_response", "King Hagler is a fool, I am Eractasswa."),
 ("gekokujo_fort_10_deputy_conquer_response", "I will meet with him, this place will be my home. I will lead as mentor."),
 ("gekokujo_fort_11_deputy_conquer_response", "Ah Tabai would've flogged you for what you have done. Now I lead the Colonial Brotherhood."),
 ("gekokujo_fort_12_deputy_conquer_response", "Grand Master Kenway, more like Grand Master {playername}. May the father of understanding guide us."),
 
 ("gekokujo_fort_1_deputy_intro", "Well {playername}, I am Humphrey Marten the local chief of the Hudson Bay Company, I'm here to serve you of course."),
 ("gekokujo_fort_2_deputy_intro", "Greetings {playername}, I am your servant in our bustling little port!"),
 ("gekokujo_fort_3_deputy_intro", "Bonjour, I am the "),
 ("gekokujo_fort_4_deputy_intro", "{playername} despite our circumstances of our meeting, I'm glad you're here. I am Isiah Thaxter a true-born son, here to make a difference, as are you I presume?"),
 ("gekokujo_fort_5_deputy_intro", "Mi name Assam. Mi an di leada fi wi revolution, Francois Mackandal, we a real tight bredren."),
 ("gekokujo_fort_6_deputy_intro", "The name is Auchagah, for many years I've traded furs to the Hudson Bay Company, and have come to know them, I'll be letting them know of my new 'business partner' soon."),
 ("gekokujo_fort_7_deputy_intro", "I am Nibi-Mamakanda, one of the last of our people to defend our homeland along our river. . . thank you for sparing us."),
 ("gekokujo_fort_8_deputy_intro", "I am here to serve you my king. I am Kokhewenaunaut, the former Waijawahn of the Muhhekunneuw."),
 ("gekokujo_fort_9_deputy_intro", "Even though you may rule over the Esaw now, King Hagler was a trusted and powerful king before you, I hope you do his memory and our people proud."),
 ("gekokujo_fort_10_deputy_intro", "The Brotherhood is happy to see that you are now our mentor, in this time of strife we need a leader who can strike down the enemies of humanity."),
 ("gekokujo_fort_11_deputy_intro", "Ah. . . {playername} it is to the benefit of the Brotherhood that you now lead us. . . I hear of your exploits frequently."),
 ("gekokujo_fort_12_deputy_intro", "May the father of understanding guide us {playername}. Have you sought out Grand Master Kenway?"),
 
 ("gekokujo_fort_1_deputy_ask_specialty", "Here at the Hudson Bay Company we are still permitted to trade weapons with the natives in order to get furs, other than that there are always those looking to hunt and bring in the furs themselves."),
 ("gekokujo_fort_2_deputy_ask_specialty", "For many years the colony has extracted salt from the great salt pond, and of course you're familiar with the famous Dutch Mariniers!"),
 ("gekokujo_fort_3_deputy_ask_specialty", "(Fort La Reine)"),
 ("gekokujo_fort_4_deputy_ask_specialty", "We have connections with the papermills as to print our pamphlets, and of course we have many volunteers who wish to see the yoke of tyranny removed."),
 ("gekokujo_fort_5_deputy_ask_specialty", "Wi mek sugar, wid free people, fi real. An' constant, yuh have Maroons a scheme fi pay back di slave master dem."),
 ("gekokujo_fort_6_deputy_ask_specialty", "Our hunters yield us much fur to trade with and they would be more than willing to join you on campaign."),
 ("gekokujo_fort_7_deputy_ask_specialty", "We fish along the river, and have warriors dedicated to you of course Mugwump."),
 ("gekokujo_fort_8_deputy_ask_specialty", "We have many meats from our hunting, and those who hunt are rarely challenged with their skills in the ways of war."),
 ("gekokujo_fort_9_deputy_ask_specialty", "Our pottery is well known through trade and is desired, besides that our warriors are known as some of the very fiercest among all the continent."),
 ("gekokujo_fort_10_deputy_ask_specialty", "On Grand Inagua our benefactor the late Master Kenway has made sure we produce rum, and then of course we train assassins."),
 ("gekokujo_fort_11_deputy_ask_specialty", "We rarely produce anything, except maybe our Brotherhood's robes. But we have many who want to wear the robes and fight for our cause."),
 ("gekokujo_fort_12_deputy_ask_specialty", "We rarely produce anything, except maybe our chapter's robes. Although we have many members who are willing to push forward the cause of humanity."),

 
 ("gekokujo_fort_1_deputy_ask_companion", "X"),
 ...
 ("gekokujo_fort_7_deputy_ask_companion", "Ugh, I see you've met Bafunkei. He is my daughter's husband's cousin's friend. Did he propose to you a scheme, or brag about his prowess?"),
 ("gekokujo_fort_8_deputy_ask_companion", "My daughter? I hope she hasn't been a bother..."),
 ("gekokujo_fort_9_deputy_ask_companion", "My daughter? I hope she hasn't been a bother..."),
 ("gekokujo_fort_10_deputy_ask_companion", "My daughter? I hope she hasn't been a bother..."),
 ("gekokujo_fort_11_deputy_ask_companion", "My daughter? I hope she hasn't been a bother..."),
 ("gekokujo_fort_12_deputy_ask_companion", "My daughter? I hope she hasn't been a bother..."),
 ...
 ("gekokujo_fort_7_deputy_ask_companion_recruit", "Please, for the love of the gods, remove him from this village as quickly as possible."),
 ("gekokujo_fort_8_deputy_ask_companion_recruit", "Please, for the love of the gods, remove him from this village as quickly as possible."),
 ("gekokujo_fort_9_deputy_ask_companion_recruit", "Please, for the love of the gods, remove him from this village as quickly as possible."),
 ("gekokujo_fort_10_deputy_ask_companion_recruit", "Please, for the love of the gods, remove him from this village as quickly as possible."),
 ("gekokujo_fort_11_deputy_ask_companion_recruit", "Please, for the love of the gods, remove him from this village as quickly as possible."),
 ("gekokujo_fort_12_deputy_ask_companion_recruit", "Please, for the love of the gods, remove him from this village as quickly as possible."),
 ...
 ("gekokujo_fort_7_deputy_ask_companion_recruited", "Strangely enough, the whole village has been asking about him. Well? Has he gotten himself killed yet?"),
 ("gekokujo_fort_8_deputy_ask_companion_recruited", "Strangely enough, the whole village has been asking about him. Well? Has he gotten himself killed yet?"),
 ("gekokujo_fort_9_deputy_ask_companion_recruited", "Strangely enough, the whole village has been asking about him. Well? Has he gotten himself killed yet?"),
 ("gekokujo_fort_10_deputy_ask_companion_recruited", "Strangely enough, the whole village has been asking about him. Well? Has he gotten himself killed yet?"),
 ("gekokujo_fort_11_deputy_ask_companion_recruited", "Strangely enough, the whole village has been asking about him. Well? Has he gotten himself killed yet?"),
 ("gekokujo_fort_12_deputy_ask_companion_recruited", "Strangely enough, the whole village has been asking about him. Well? Has he gotten himself killed yet?"),
 ...
 ("gekokujo_fort_7_deputy_ask_companion_promoted", "Bah! Unbelievable! But... How is the boy doing? Is he happy?"),
 ("gekokujo_fort_8_deputy_ask_companion_promoted", "Bah! Unbelievable! But... How is the boy doing? Is he happy?"),
 ("gekokujo_fort_9_deputy_ask_companion_promoted", "Bah! Unbelievable! But... How is the boy doing? Is he happy?"),
 ("gekokujo_fort_10_deputy_ask_companion_promoted", "Bah! Unbelievable! But... How is the boy doing? Is he happy?"),
 ("gekokujo_fort_11_deputy_ask_companion_promoted", "Bah! Unbelievable! But... How is the boy doing? Is he happy?"),
 ("gekokujo_fort_12_deputy_ask_companion_promoted", "Bah! Unbelievable! But... How is the boy doing? Is he happy?"),
 ...
 ("gekokujo_fort_7_companion_meet", "Oh! {Chief/Chieftess}! Fancy meeting you here. I'm Shay Cormac, the most able warrior in the village."),
 ("gekokujo_fort_8_companion_meet", "Oh! {Chief/Chieftess}! Fancy meeting you here. I'm Shay Cormac, the most able warrior in the village."),
 ("gekokujo_fort_9_companion_meet", "Oh! {Chief/Chieftess}! Fancy meeting you here. I'm Shay Cormac, the most able warrior in the village."),
 ("gekokujo_fort_10_companion_meet", "Oh! {Chief/Chieftess}! Fancy meeting you here. I'm Shay Cormac, the most able warrior in the village."),
 ("gekokujo_fort_11_companion_meet", "Oh! {Chief/Chieftess}! Fancy meeting you here. I'm Shay Cormac, the most able warrior in the village."),
 ("gekokujo_fort_12_companion_meet", "Oh! {Chief/Chieftess}! Fancy meeting you here. I'm Shay Cormac, the most able warrior in the village."),
 ...
 ("gekokujo_fort_7_companion_intro", "Welcome home, {Chief/Chieftess}!"),
 ("gekokujo_fort_8_companion_intro", "Welcome home, {Chief/Chieftess}!"),
 ("gekokujo_fort_9_companion_intro", "Welcome home, {Chief/Chieftess}!"),
 ("gekokujo_fort_10_companion_intro", "Welcome home, {Chief/Chieftess}!"),
 ("gekokujo_fort_11_companion_intro", "Welcome home, {Chief/Chieftess}!"),
 ("gekokujo_fort_12_companion_intro", "Welcome home, {Chief/Chieftess}!"),
 ...
 ("gekokujo_fort_7_companion_about", "I am Banfunkei, and I will make a name for myself any day now, if only I would be allowed the chance."),
 ("gekokujo_fort_8_companion_about", "I am Chufsanma, niece of Chief Aterui."),
 ("gekokujo_fort_9_companion_about", "I am Chufsanma, niece of Chief Aterui."),
 ("gekokujo_fort_10_companion_about", "I am Chufsanma, niece of Chief Aterui."),
 ("gekokujo_fort_11_companion_about", "I am Chufsanma, niece of Chief Aterui."),
 ("gekokujo_fort_12_companion_about", "I am Chufsanma, niece of Chief Aterui."),
 
 ("gekokujo_fort_1_companion_recruit", "Thank you for this opportunity, {Chief/Chieftess}! You won't regret it!"),
 ("gekokujo_fort_2_companion_recruit", "Thank you for this opportunity, {Chief/Chieftess}! You won't regret it!"),
 ("gekokujo_fort_3_companion_recruit", "Thank you for this opportunity, {Chief/Chieftess}! You won't regret it!"),
 ("gekokujo_fort_4_companion_recruit", "Thank you for this opportunity, {Chief/Chieftess}! You won't regret it!"),
 ("gekokujo_fort_5_companion_recruit", "Thank you for this opportunity, {Chief/Chieftess}! You won't regret it!"),
 ("gekokujo_fort_6_companion_recruit", "Thank you for this opportunity, {Chief/Chieftess}! You won't regret it!"),
 ("gekokujo_fort_7_companion_recruit", "Thank you for this opportunity, {Chief/Chieftess}! You won't regret it!"),
 ("gekokujo_fort_8_companion_recruit", "Thank you for this opportunity, {Chief/Chieftess}! You won't regret it!"),
 ("gekokujo_fort_9_companion_recruit", "Thank you for this opportunity, {Chief/Chieftess}! You won't regret it!"),
 ("gekokujo_fort_10_companion_recruit", "Thank you for this opportunity, {Chief/Chieftess}! You won't regret it!"),
 ("gekokujo_fort_11_companion_recruit", "Thank you for this opportunity, {Chief/Chieftess}! You won't regret it!"),
 ("gekokujo_fort_12_companion_recruit", "Thank you for this opportunity, {Chief/Chieftess}! You won't regret it!"),

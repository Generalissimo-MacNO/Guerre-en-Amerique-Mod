...
##        (overlay_set_color, reg1, 0),
        ...
        (assign, reg0, ":wealth"),
        (create_text_overlay, reg1, "@Wealth: {reg0} Spanish Dollars", 0),
        (position_set_x, pos1, 750),
        (position_set_y, pos1, 750),
        (overlay_set_size, reg1, pos1),
        (position_set_x, pos1, 600),
        ...
        (create_text_overlay, reg1, "@Inventory: {reg0} Spanish Dollars", 0),
        (position_set_x, pos1, 750),
        (position_set_y, pos1, 750),
        (overlay_set_size, reg1, pos1),
        (position_set_x, pos1, 600),
    ...
    ("dplmc_peace_terms",0,mesh_load_window,[
      (ti_on_presentation_load,
       [
        ...
        (create_text_overlay, "$g_presentation_obj_sliders_2", "@1000 Spanish Dollars"),
        (position_set_x, pos1, 500),
        (overlay_set_position, "$g_presentation_obj_sliders_2", pos1),

...
map_icons = [
  ...
  #Start Guerre en Amerique Additions
  
  #Anim
  ("native",0,"map_native", avatar_scale,snd_footstep_grass, 0.15, 0.173, 0),
  
  #Static
  ("native_village",mcn_no_shadow,"map_native_village", 0.25,0),
  ("native_castle",mcn_no_shadow,"map_native_castle", 0.25,0),
  ("native_town",mcn_no_shadow,"map_native_town", 0.25,0),
  
  ("french_village",mcn_no_shadow,"map_french_village", 0.25,0),
  ("french_town",mcn_no_shadow,"map_french_town", 0.25,0),
  ("british_village",mcn_no_shadow,"map_british_village", 0.25,0),
  ("british_town",mcn_no_shadow,"map_british_town", 0.25,0),  
  ("spanish_village",mcn_no_shadow,"map_spanish_village", 0.25,0),
  ("spanish_town",mcn_no_shadow,"map_spanish_town", 0.25,0),
  
  ("wood_fort",mcn_no_shadow,"map_wood_fort", 0.25,0), 
  ("stone_fort",mcn_no_shadow,"map_stone_fort", 0.25,0),
  ("brick_fort",mcn_no_shadow,"map_brick_fort", 0.25,0),  
  
  #End Guerre en Amerique Additions

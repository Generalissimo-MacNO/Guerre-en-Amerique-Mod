...
#MOD BEGIN - firearms
itp_pistol_firearm =                           itp_primary|itp_wooden_parry|itp_no_blur|itp_cant_reload_while_moving #can reload while moving on horse, that's covered by itp_cant_reload_while_moving_mounted
itp_pistol_melee   =                           itp_primary|itp_wooden_parry|itp_no_blur|itp_offset_musket|itp_wooden_attack
itp_musket_firearm = itp_unique|itp_two_handed|itp_primary|itp_wooden_parry|itp_no_blur
itp_musket_blunt   = itp_unique|itp_two_handed|itp_primary|itp_wooden_parry|itp_no_blur|itp_offset_musket|itp_wooden_attack
itp_musket_blade   = itp_unique|itp_two_handed|itp_primary|itp_wooden_parry|itp_no_blur
itp_musket_bayonet = itp_unique|itp_two_handed|itp_primary|itp_wooden_parry|itp_no_blur|itp_has_upper_stab #itp_has_upper_stab should be used in tandem with itcf_overswing_spear (former makes overswing use thrust damage, latter sets the animation to thrust)
#MOD END - firearms
...
#MOD BEGIN - firearms
itc_pistol_firearm  = itcf_carry_pistol_front_left|itcf_shoot_pistol|itcf_reload_pistol
itc_pistol_melee    = itcf_carry_pistol_front_left|itc_cleaver
itc_musket_firearm  = itcf_carry_spear            |itcf_shoot_musket|itcf_reload_musket
itc_musket_blunt    = itcf_carry_spear            |itcf_overswing_musket |itcf_thrust_musket |                            itcf_slashright_twohanded|itcf_slashleft_twohanded|itcf_horseback_slashright_onehanded|itcf_horseback_slashleft_onehanded
itc_musket_blade    = itcf_carry_spear            |itcf_overswing_polearm|itcf_thrust_polearm|itcf_thrust_onehanded_lance|itcf_slashright_polearm  |itcf_slashleft_polearm
itc_musket_bayonet  = itcf_carry_spear            |itcf_overswing_spear  |itcf_thrust_polearm|itcf_thrust_onehanded_lance #overswing_spear is the upper stab animation; good for stabbing bayonets, for bladed ones itc_musket_blade might be better?
#MOD END - firearms

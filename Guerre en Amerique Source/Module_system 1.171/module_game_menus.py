...
game_menus = [
  ...
  ("start_phase_2",mnf_disable_all_keys,
    "You hear about North America, a land torn between great European empires and the original inhabitants vying for control,\
 an opportunity for eager colonists, willing to risk their lives in pursuit of fortune, power, or glory...\
 ...
 and that whatever course you take, great adventures will await you. Drawn by the stories you hear about the Americas and its undecided fate, you...",
    "none",
    [],
    [
      ("town_1",[(eq, "$current_startup_quest_phase", 0),],"Sail to the French fortress town of Louisbourg, the gate to New France.",
       [
         (assign, "$current_town", "p_town_9"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_louisbourg"),
		 (jump_to_menu, "mnu_start_phase_2_5"),
       ]),
       
      ("town_2",[(eq, "$current_startup_quest_phase", 0),],"Go to the center of trade along the Hudson and middle colonies, New York.", 
       [
         (assign, "$current_town", "p_town_4"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_new_york"),
		 (jump_to_menu, "mnu_start_phase_2_5"),
       ]),
       
      ("town_3",[(eq, "$current_startup_quest_phase", 0),],"Head down the Saint Lawrence, through the Great Lakes, and arrive d'en Pays Haut at Fort Pontchartrain.",
       [
         (assign, "$current_town", "p_town_29"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_waawiyaatanong"),
		 (jump_to_menu, "mnu_start_phase_2_5"),
       ]),
       
      ("town_4",[(eq, "$current_startup_quest_phase", 0),],"Skip the shrewd traders, and thieves of the English colonies, and march over the Alleghenies to the Ohio country.",
       [
         (assign, "$current_town", "p_town_28"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_sonnontio"),
		 (jump_to_menu, "mnu_start_phase_2_5"),
       ]),
       
      ("town_5",[(eq, "$current_startup_quest_phase", 0),],"Sail to the hub of Caribbean trade, the city of columns, Havana.",
       [
         (assign, "$current_town", "p_town_16"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_havana"),
		 (jump_to_menu, "mnu_start_phase_2_5"),
       ]),
       
      ("town_6",[(eq, "$current_startup_quest_phase", 0),],"Find yourself in the location of the eternal flame, the heart of the Iroquois, Onondaga.",
       [
         (assign, "$current_town", "p_town_20"),
         (assign, "$g_starting_town", "$current_town"),
         (assign, "$g_journey_string", "str_journey_to_onondaga"),
		 (jump_to_menu, "mnu_start_phase_2_5"),
       ]),
...
##diplomacy end+
  ...
  (
    ...
    "You were born as we all are to. . .",
    "none",
    [
    (str_clear,s10),
    (str_clear,s11),
    ...
    [
    ("start_noble",[],"A family of political influence and power.",[
      (assign,"$background_type",cb_noble),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You came into the world a {reg3?daughter:son} of real, but declining gentry,\
 declining however still far better off than your run of the mill serf, peasant, or yeoman, so\
 they afforded you a good education and trained you from childhood for life as a leader of people."),
	(jump_to_menu,"mnu_start_character_2"),
    ]),
    ("start_nomad",[],"A native chief and his wife.",[
      (assign,"$background_type",cb_nomad),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@{reg3?daughter:son}"),
      (str_store_string,s10,"@You were a child of a minor chief, with the ability to rouse others into\
 calls of war or calls of peace,\
 though with your position you learned of the Europeans and their effects on the land.\
 Your family taught you as much as they could, but only life could teach you the rest."),
	(jump_to_menu,"mnu_start_character_2"),
    ]),
    ("start_merchant",[],"A merchant family.",[
      (assign,"$background_type",cb_merchant),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You were born the {reg3?daughter:son} of merchants,\
 always organizing convoys or caravans across the world. Although your parents were wealthier than most\
 and educated you as well as they could, you found little opportunity to make friends on the seas or roads,\
 living mostly for the moments when you could sell something to somebody."),
	(jump_to_menu,"mnu_start_character_2"),
    ]),
    ("start_guard",[],"A professional soldier and his wife.",[
      (assign,"$background_type",cb_guard),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@As a child, your family scrabbled out a living from your father's stipend\
 as a noncommissioned officer. It was not an easy existence, and you weren't able to get much of an\
 education. You learned mainly how to defend yourself on the streets, with or without a weapon in hand."),
	(jump_to_menu,"mnu_start_character_2"),
    ]),
    ("start_forester",[],"Fur trappers.",[
 ...
 wildlife, and land. Hunting, woodcutting, making shelters, and the like, but\
 it taught you self sufficiency. Winter was never a good time for your family\
 as the cold took animals and people alike, but you always lived to see another dawn,\
 though all your brothers and sisters were not so fortunate."),
	(jump_to_menu,"mnu_start_character_2"),
    ]),
    ("start_thief",[],"A destitute family.",[
      (assign,"$background_type",cb_thief),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@As the {reg3?daughter:son} of a debtor, you had no 'formal' education.\
 ...
 Still, these long years made you streetwise and sharp to the secrets of cities and shadowy backways."),
  ...
  (
    "start_character_2",0,
    "{s10}^^ You began to walk, talk, and observe the world around you. You spent your early life as...",
    "none",
    [],
    [
      ("attendant",[(eq,"$character_gender",tf_male)],"A governor's attendant.",[
      (assign,"$background_answer_2", cb2_page),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@As a {reg3?girl:boy} growing out of childhood,\
 you were sent to live in one of the governor's households.\
 There, your first lessons were in humility, as you waited upon the household, and their guests.\
 But from their social gatherings, sojourns, gossip, you quickly began to learn about the adult world of conflict\
 and competition. You even learned from the machinations of the other children, who formed cliques and fought amongst themselves under the noses of their elders."),
	(jump_to_menu,"mnu_start_character_3"),
    ]),
	#gekokujo 3.0 different text for women
      ("handmaiden",[(eq,"$character_gender",tf_female)],"A household attendant.",[
      (assign,"$background_answer_2", cb2_page),
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@As a {reg3?girl:boy} growing out of childhood,\
 you were sent to live in one of the governor's households.\
 ...
 you wished to stay."),
	(jump_to_menu,"mnu_start_character_3"),
      ...
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@As a {reg3?girl:boy} growing out of childhood,\
 you apprenticed to a wealthy merchant, picking up the trade over years of working shops and portaging goods.\
 You soon became adept at the art of buying low, selling high, and leaving the customer thinking they'd\
 got the better deal."),
	(jump_to_menu,"mnu_start_character_3"),
    ]),
      ("tatterdemalion",[],"A tatterdemalion.",[
 ...
 always undermining the law and those who sought to punish you."),
	(jump_to_menu,"mnu_start_character_3"),
    ]),
      ("mountaineer",[
          ],"A frontier child.",[
      ...
      (assign, reg3, "$character_gender"),
      (str_store_string,s11,"@As a {reg3?girl:boy} growing out of childhood,\
 you lived in the depths of the wilderness, surviving away from civilization.\
 Although often hungry, you became a skillful hunter and pathfinder in this untamed country.\
 Your body hardened with muscle as you endured your rough life."),
	(jump_to_menu,"mnu_start_character_3"),
    ]),
      ("go_back",[],"Go back.",
     [(jump_to_menu,"mnu_start_character_1"),
  ...
  (
    ...
    "{s11}^^ Then, as a young adult, life progressed you into a state of feeble autonomy. You became...",
    "none",
    [(assign, reg3, "$character_gender"),],
    [
      ("officer",[(eq,"$character_gender",tf_male)],"A member of the militia, with a commission",[
 ...
 You signed up as a member of the miltia, your connections brought you around officers,\
 those officers saw the strapping young man and were able to support your bid for a commission.\
 You were instructed in your obligations to your subordinates, though more pertinently your betters.\
 But in addition to learning the concepts of European discipline, you also learned about the grueling\
 sieges, political consequences in the colonies. The taxes and lives imposed upon for the sake of a different continent's\
 benefit. Though the power of the colonies comes from Europe and the power of Europe from the colonies."),
	(jump_to_menu,"mnu_start_character_4"),
        ]),
      ("lady",[(eq,"$character_gender",tf_female)],"A .",[
...
#          (try_end),
        ...
        (try_begin),
          (eq, "$g_encountered_party_template", "pt_looters"), #looters
...
##        (call_script, "script_change_troop_renown", "trp_player", 1),
  ...
  (
	...
	##diplomacy begin
    "{s3} has fallen to your troops, and you now have full control of the {reg2?town:castle}. You can plunder spoils of war worth {reg3} Spanish Dollars.\
...
##  ),
  ...
  (
    ...
    [
      ...
      (try_begin),
		...
		(str_store_string, s2, "@the burnt-out ruins of {s2}. You spot some wretched souls among the wreckage, but they do their best to make haste and hide"),
		(set_background_mesh, "mesh_pic_looted_village"),
      (else_try),
	    (party_slot_eq, "$current_town", slot_fort_captured, 0),
	    (eq, "$g_battle_result", -1),
		(str_store_string, s2, "@{s2}. Beaten back by their formidable skill at arms you find yourself withdrawing"),
	    (set_background_mesh, "mesh_gekokujo_pic_bandits_2"),
      (else_try),
	    (party_slot_eq, "$current_town", slot_fort_captured, 0),
		(str_store_string, s2, "@{s2}. Observing the defenses it is obvious these are dedicated soldiers anticipating an attack"),
	    (set_background_mesh, "mesh_gekokujo_pic_bandits_1"),
      (else_try),
		(str_store_string, s2, "@{s2}. The individuals standing guard recognize you, their proprietor, and quickly stand at a rugged form of attention"),
      (try_end),
  ...
  (
    ...
    "Valiantly enough your soldiers, at risk of their own lives, pull your limp body out of the mess. They then insist on withdrawal.",
    "none",
    [
	    #Check for victory or defeat....
        (assign, "$g_enemy_party", "$g_encountered_party"),
  ...
  (
    ...
    "You have captured {s2}! What will you do from here? You have enough leadership to control {reg1} forts and currently have {reg2} under your control.",
    "none",
    [
      (str_store_party_name, s2, "$current_town"),
	  (party_clear, "$g_encountered_party"),
  ...
  (
    ...
    [
        ...
        (else_try),
          (eq, ":center_lord", "trp_player"),
          (str_store_string,s11,"@ This settlement and the surrounding lands belong to you."),
		##diplomacy start+ If reg0 > 0, a relation string has been written into s11
		(else_try),
		  (ge, reg0, 1),
		  (str_store_string,s11,"@ You remember that this settlement and the surrounding lands belong to your {s11} {s7}."),
		##diplomacy end+
        (else_try),
          (ge, ":center_lord", 0),
          (str_store_string,s11,"@ You remember that this settlement and the surrounding lands belong to {s7}."),
        (else_try),
        ...
        (try_begin),
          ...
          (else_try),
           ##diplomacy begin
            ...
            (str_store_string, s6, "@ The peasants hired mercenaries and are revolting against you."),
        ...
        (else_try),
          (party_slot_eq, "$current_town", slot_village_state, svs_looted),
          (str_store_string, s6, "@ The village has been decimated. Humanoid figures watch you as you pass."),
          (try_begin),
...
#	#From HokieBT
      ...
      ("dplmc_village_elder_meeting",[
       ...
       ,"Meet the village representative.",
       [
         (try_begin),
           (call_script, "script_cf_enter_center_location_bandit_check"),
         (else_try),
	...
	[
       ...
       "You have not met the village representative yet.",
       [
     ]),
	 ##diplomacy end+
  ...
  (
    ...
    [
      ("village_take_food",[
          ...
          ],"Force the residents to give you supplies.",
       [
...
#     (store_div, ":gold_capacity", ":gold", 10),#10 mon per man
     (try_begin),
       ...
       (store_div, ":gold_capacity", ":gold", 100),
     (else_try),
       (store_div, ":gold_capacity", ":gold", 10),
     (try_end),
	 
	 #GeA Native Brave recruitment start
     ...
     (try_begin),
       ...
       (this_or_next|eq, "$current_town", "p_town_28"),
       (this_or_next|eq, "$current_town", "p_town_29"),
     ...
     (try_end),
	 #GeA Native Brave recruitment end
...
#       (store_mul, reg6, ":volunteer_amount", 10),#10 mon per man
        (try_begin),
		  ...
		  (try_begin),
            ...
            (party_slot_eq, "$current_town", slot_center_culture, "fac_culture_10"),
            ...
            (party_slot_eq, "$current_town", slot_center_culture, "fac_culture_13"),
            (party_slot_eq, "$current_town", slot_center_culture, "fac_culture_14"),
            ...
            (party_slot_eq, "$current_town", slot_center_culture, "fac_culture_18"),
            (party_slot_eq, "$current_town", slot_center_culture, "fac_culture_19"),
            (party_slot_eq, "$current_town", slot_center_culture, "fac_culture_20"),
			(store_mul, reg6, ":volunteer_amount", 50),
			(assign, reg8, 50), #GeA -- display cost when recruiting only a single native
			(assign, reg9, 100), #GeA -- display cost when recruiting only two
			(assign, reg10, 150), #GeA -- display cost when recruiting only three
			(assign, reg11, 200), #GeA -- display cost when recruiting only four
			(assign, reg12, 250), #GeA -- display cost when recruiting only five
		  (else_try),
		    (store_mul, reg6, ":volunteer_amount", 100),
			(assign, reg8, 100), #GeA -- display cost when recruiting only a single regular
			(assign, reg9, 200), #GeA -- display cost when recruiting only two
			(assign, reg10, 300), #GeA -- display cost when recruiting only three
			(assign, reg11, 400), #GeA -- display cost when recruiting only four
			(assign, reg12, 500), #GeA -- display cost when recruiting only five
		  (try_end),
        (else_try),
          (store_mul, reg6, ":volunteer_amount", 10),
		  (assign, reg8, 10), #GeA -- display cost when recruiting only a single village recruit
		  (assign, reg9, 20), #GeA -- display cost when recruiting only two
		  (assign, reg10, 30), #GeA -- display cost when recruiting only three
		  (assign, reg11, 40), #GeA -- display cost when recruiting only four
		  (assign, reg12, 50), #GeA -- display cost when recruiting only five
        (try_end),
...
#					(assign, "$g_last_assassination_attempt_perpetrator", ":lord"),
             ...
             (try_begin),
               ...
               (try_begin),
                 ...
                 (assign, ":troop_of_merchant", "trp_louisbourg_merchant"),
               (else_try),  
                 (eq, "$g_encountered_party_faction", "fac_kingdom_1"),
                 (assign, ":troop_of_merchant", "trp_new_york_merchant"),
               (else_try),                   
                 (eq, "$g_encountered_party_faction", "fac_kingdom_2"),
                 (assign, ":troop_of_merchant", "trp_waawiyaatanong_merchant"),
               (else_try),  
                 (eq, "$g_encountered_party_faction", "fac_kingdom_2"),
                 (assign, ":troop_of_merchant", "trp_sonnontio_merchant"),
               (else_try),  
                 (eq, "$g_encountered_party_faction", "fac_kingdom_3"),
                 (assign, ":troop_of_merchant", "trp_havana_merchant"),
               (else_try),  
                 (eq, "$g_encountered_party_faction", "fac_kingdom_4"),
                 (assign, ":troop_of_merchant", "trp_onondaga_merchant"),
               (try_end),
...
##          ]),
 ...
 In addition to honour, fame and glory, you earn a prize of {reg9} mon. {s8}",
  ...
  (
    ...
    "You've collected {reg3} Spanish Dollars in taxes from {s3}. {s19} will be expecting you to take the money to {reg4?her:him}.",
	##diplomacy end+
    "none",
    [(str_store_party_name, s3, "$current_town"),
...
##diplomacy start+ fix gender of pronoun
    "You could collect only {reg3} Spanish Dollars as tax from {s3} before the revolt broke out.\
...
##diplomacy end+
  ...
  (
    ...
    "You now possess land in your name, an independent force on this continent of rival empires. You're now a contender vying for control, with your seat of power at {s12}. However, the landed contenders look upon you as a sort of threat. Not directly but instead to their legitimacy.^^You may find it desirable at this time to relenquish independence, taking up arms for a proprietor as to be under their protection. If it is your wish to maintain your state of independence, your primary endeavor should be to establish 'right to rule.' You can establish your right to rule through several means -- marrying into an influential family, employing those to do your bidding, governing your lands, treating with other factions, or dispatching your agents on missions.^^At any rate, your first step should be to appoint a chief minister from among your companions, to handle affairs of state. Different companions have different capabilities.^You may appoint new ministers from time to time. You may also change the location of your government, by speaking to the aforementioned minister.",
    "none",
    [
      (set_fixed_point_multiplier, 100),
      (position_set_x, pos0, 65),
    ...
    [
	  ...
	  [
	    ...
	    (else_try),
	      ...
	      (assign, ":bandit_troop", "trp_pirate"),
	      (assign, ":bandit_troop_2", "trp_pirate"),
...
#gekokujo 3.0 integrating 1.158 end
  ...
  ("start_phase_3",mnf_disable_all_keys,
    "{s16}^^You are exhausted by the time you find the inn in {s1}, and fall asleep quickly. You awaken before dawn, your mind restless and eager to explore. The streets lie quiet and empty as you step out into the seemingly lifeless town, the faint glow of the rising sun has yet to touch the horizon. Then the cocking of a musket breaks the silence- confirming that in this land anyone will do anything to survive. You're determined to play by these new rules. . .",
    "none",
    [      
      (assign, ":continue", 1),
      (try_begin),
    ...
    [
      ...
      [         
        ...
        (try_begin),
          ...
          (assign, ":town_merchant", "trp_louisbourg_merchant"),
          (assign, ":town_room_scene", "scn_town_9_room"),
        (else_try),  
          (eq, "$current_town", "p_town_4"),
          (assign, ":town_merchant", "trp_new_york_merchant"),
          (assign, ":town_room_scene", "scn_town_4_room"),
        (else_try),  
          (eq, "$current_town", "p_town_29"),
          (assign, ":town_merchant", "trp_waawiyaatanong_merchant"),
          (assign, ":town_room_scene", "scn_town_29_room"),
        (else_try),  
          (eq, "$current_town", "p_town_28"),
          (assign, ":town_merchant", "trp_sonnontio_merchant"),
          (assign, ":town_room_scene", "scn_town_28_room"),
        (else_try),  
          (eq, "$current_town", "p_town_16"),
          (assign, ":town_merchant", "trp_havana_merchant"),
          (assign, ":town_room_scene", "scn_town_16_room"),
        (else_try),  
          (eq, "$current_town", "p_town_20"),
          (assign, ":town_merchant", "trp_onondaga_merchant"),
          (assign, ":town_room_scene", "scn_town_20_room"),
        (try_end),        
  ...
  ("establish_court",mnf_disable_all_keys,
    "To establish {s4} as the center of your operations, you'll need to rennovate some buildings. This will require a PLACEHOLDER and PLACEHOLDER.",
    "none",
    [

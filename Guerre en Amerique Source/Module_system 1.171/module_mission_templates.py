...
#Guerre en Amerique Bayonet mission templates, fucking jesus



#GeA equipment distributions-
...
common_gekokujo_equip = (ti_on_agent_spawn, 0, 0, [],
	[
		...
		(try_begin),
			...
			(try_begin),
                (this_or_next|eq, ":troop_faction", "fac_kingdom_1"), #British
                (this_or_next|eq, ":troop_faction", "fac_kingdom_2"), #French
				(eq, ":troop_faction", "fac_kingdom_3"), #Spanish
				(assign, ":gunner_ratio", 100), #100% muskets
			(else_try),
                (this_or_next|eq, ":troop_faction", "fac_kingdom_4"), #Iroquois
                (this_or_next|eq, ":troop_faction", "fac_kingdom_6"), #Wabanaki
				(eq, ":troop_faction", "fac_kingdom_7"), #Mohawk
				(assign, ":gunner_ratio", 85), #85% muskets
			(else_try),
                (this_or_next|eq, ":troop_faction", "fac_kingdom_5"), #Cherokee
				(eq, ":troop_faction", "fac_kingdom_6"), #Huron
				(assign, ":gunner_ratio", 75), #75% muskets
			(else_try),
                (this_or_next|eq, ":troop_faction", "fac_kingdom_9"), #Lenape
                (this_or_next|eq, ":troop_faction", "fac_kingdom_11"), #Shawnee
				(eq, ":troop_faction", "fac_kingdom_12"), #Odawa
				(assign, ":gunner_ratio", 65), #65% muskets
			(else_try),
                (this_or_next|eq, ":troop_faction", "fac_kingdom_10"), #Miami
                (this_or_next|eq, ":troop_faction", "fac_kingdom_13"), #Ojibwe
                (this_or_next|eq, ":troop_faction", "fac_kingdom_14"), #Potawatomi
                (this_or_next|eq, ":troop_faction", "fac_kingdom_15"), #Choctaw
                (this_or_next|eq, ":troop_faction", "fac_kingdom_16"), #Chickasaw
				(eq, ":troop_faction", "fac_kingdom_17"), #Creek
				(assign, ":gunner_ratio", 60), #60% muskets
			(try_end),
			...
			(try_begin), #on success, turn them into a gunner
				...
				(try_begin),
					...
					(agent_set_wielded_item,":agent_no","itm_gekokujo_arquebus_1"),
				(else_try),
  ...
  (
    ...
    [
      ...
      [              
        ...
        (try_begin),
          (agent_get_troop_id, ":troop_no", ":agent_no"),
          (is_between, ":troop_no", "trp_louisbourg_merchant", "trp_startup_merchants_end"),
          (agent_set_team, ":agent_no", 7),          
          (team_set_relation, 0, 7, 0), 
        (try_end),                
      ]),
        ...
        (lt, "$merchant_sign_count", 8),
          ...
          (get_player_agent_no, ":player_agent"),
  	      (try_for_agents, ":agent_no"),
  	        ...
  	        (ge, ":agent_troop_id", "trp_louisbourg_merchant"),
